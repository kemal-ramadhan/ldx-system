...
const form = useForm({
    ...
    company_npwp: props.client.company_npwp || '',
    company_address: props.client.company_address || '',
    company_city: props.client.company_city || '',
    company_province: props.client.company_province || '',
    company_postal_code: props.client.company_postal_code || '',
    contract_date: props.client.contract_date || '',
    contract_done_date: props.client.contract_done_date || '',
...
<template>
    ...
    <div class="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
        <h1 class="text-xl font-bold">Edit Client {{ props.client?.company_name || '' }}</h1>
        ...
        <div class="flex items-center justify-end gap-4">
             <Button
                ...
                @click="$inertia.visit('/admin/clients')"
            >
                Cancel
            </Button>
            <Button
