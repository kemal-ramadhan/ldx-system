...
const createLocation = () => {
    form.post(`/admin/tickets-category`);
};
...
<template>
    ...
    <div class="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
        <h1 class="text-xl font-bold">Create Ticket Category</h1>
        <!-- Add your form fields here -->
        <Form @submit.prevent="createLocation" v-slot="{ errors, processing }" class="flex flex-col gap-3">
            ...
            <div class="flex items-center justify-end gap-4">
                ...
                <Button type="submit" :disabled="form.processing"
                    ...
                    {{ form.processing ? 'Creating...' : 'Create Categoriy' }}
                </Button>
            </div>
        </Form>
    </div>
